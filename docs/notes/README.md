...
| [frontend-modules.md](frontend-modules.md) | moving code between `static/js/` modules, or adding to `core.js` — the rules that keep the import graph safe |
| [grid.md](grid.md) | the virtualized grid in `static/js/grid.js` — rendering, the page cache, selection, scroll geometry |
